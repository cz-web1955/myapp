  ...
  <div id="content-box" style="width:100%;" class="box">
    ...
    <div class="second">
      <div class="second_box1">
        <img src="../../static/img/ryjbxx.png" alt />
        <p>入住人员信息登记</p>
      </div>
...
export default {
  ...
  methods: {
    checkfzID() {
      ...
      this.iderr = "";
      window.sessionStorage.setItem("ryrzid", this.fzID);
      return true;
    },
    checkfzName() {
      if (this.fzName == "") {
      ...
      this.nameerr = "";
      window.sessionStorage.setItem("ryrzname", this.fzName);
      return true;
    },
    checkfzPhone() {
      if (this.fzPhone == "") {
      ...
      if (
        ...
        Toast("电话长度为7，8，11，12位");
        return false;
      }
      this.phoneerr = "";
      window.sessionStorage.setItem("ryrzphone", this.fzPhone);
      return true;
    },
    checkfzgzdw() {
      if (this.gzdw == "") {
      ...
      window.sessionStorage.setItem("ryrzgzdw", this.gzdw);
      return true;
    },
    xyb() {
      var flag = this.checkfzID() && this.checkfzName() && this.checkfzPhone()&&this.checkfzgzdw();
      if (flag) {
        this.$router.push("/ryjzqkxx");
      }
    },
    syb() {
  ...
  created() {
    let id = window.sessionStorage.getItem("ryrzid");
    let name = window.sessionStorage.getItem("ryrzname");
    let phone = window.sessionStorage.getItem("ryrzphone");
    let gzdw = window.sessionStorage.getItem("ryrzgzdw");
    if (id) {
      this.fzID = id;
    }
    if (name) {
